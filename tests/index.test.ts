...
import * as portalnesia from '../src/index'
...
describe('Utils Testing', () => {
  ...
  describe("uuid()", () => {
    it("v4", () => {
      const uid = portalnesia.uuid();
      expect(typeof uid).toBe("string")
    })
    it("v5", () => {
      const uid = portalnesia.uuid("v5 namespace");
      expect(typeof uid).toBe("string")
    })
  })
  ...
  describe("nanoid", () => {
    it("no parameter", () => {
      const uid = portalnesia.nanoid();
      expect(typeof uid).toBe("string")
    })
    it("50 size", () => {
      const uid = portalnesia.nanoid(50);
      expect(typeof uid).toBe("string")
      expect(uid.length).toBe(50)
    })
  })
})